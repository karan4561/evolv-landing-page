...
function revolution() {
  return (
    <div className="flex flex-col overflow-hidden justify-center items-center pt-[250px] md:pt-[250px] pb-[256px] md:pb-[190px]">
      ...
      <div className="md:hidden border-2 rounded-full h-[155px] w-[155px] mt-[120px] border-primaryRed p-[12.27px]">
            <Image
