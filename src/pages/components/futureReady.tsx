  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center md:hidden">
        <p className="text-[40px] text-center leading-[45px] font-bold w-[273px] text-white">
          <span className="font-array text-primaryRed">Future ready </span>in 5
          mins
        </p>
        <p className="font-satoshi text-lg pb-[60px] w-[303px] text-center text-white pt-[40px]">
          Launch Dynamic Interactive NFTs using our End-to-End SaaS Platform in
          less than 5 minutes.
        </p>
        <button className="px-[77px] mb-28 py-2 rounded-xl text-center font-satoshi text-base  border-2 text-white  border-primaryRed">
          Lets Talk
        </button>
      </div>

      {/* // Desktop Version */}
      <div className="hidden md:flex flex-row space-x-[10%] pt-36 justify-between px-20">
        <div className="flex flex-col items-start">
          ...
          <p className="font-satoshi text-2xl pb-[50px] leading-10 w-[502px] text-left text-white pt-[54px]">
            Launch Dynamic Interactive NFTs using our End-to-End SaaS Platform
            <span className="font-satoshi700">   in less than 5 minutes.</span>
          </p>
